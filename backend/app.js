...
const serviceFieldTemplatesRoutes = require('./api/services/service-field-templates');
...
app.use('/api/service-field-templates', rateLimiters.api.middleware(), serviceFieldTemplatesRoutes);
